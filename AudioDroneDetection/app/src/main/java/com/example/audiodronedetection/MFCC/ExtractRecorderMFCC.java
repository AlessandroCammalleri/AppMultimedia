    ...
    public void doExtractionRecorder (JLibrosa jLibrosa, String recorderFilePath, String predictFilePath){
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                //Extraction of MFCCs for file aquired through the recorder
                try {
                    ...
                    //Predict File creation.
                    //It will be used from SVM to predict if Audiorecording was a drone or not
                    try {
