...
public class RecordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnStartPlay).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String path = Environment.getExternalStorageDirectory().getAbsolutePath() + "/DroneDetection/AudioRecording.wav";
    ...
    private void launchTask() {
        ...
        File wavFile = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/DroneDetection", "AudioRecording.wav");
